...
CREATE TABLE IF NOT EXISTS properties (
    ...
    people_name_1 TEXT, people_role_1 TEXT, people_phone_1 TEXT, people_note_1 TEXT,
    people_name_2 TEXT, people_role_2 TEXT, people_phone_2 TEXT, people_note_2 TEXT,
    people_name_3 TEXT, people_role_3 TEXT, people_phone_3 TEXT, people_note_3 TEXT,
    people_name_4 TEXT, people_role_4 TEXT, people_phone_4 TEXT, people_note_4 TEXT,
    people_name_5 TEXT, people_role_5 TEXT, people_phone_5 TEXT, people_note_5 TEXT,
    people_name_6 TEXT, people_role_6 TEXT, people_phone_6 TEXT, people_note_6 TEXT,
    people_name_7 TEXT, people_role_7 TEXT, people_phone_7 TEXT, people_note_7 TEXT,
    people_name_8 TEXT, people_role_8 TEXT, people_phone_8 TEXT, people_note_8 TEXT,
    people_name_9 TEXT, people_role_9 TEXT, people_phone_9 TEXT, people_note_9 TEXT,
    people_name_10 TEXT, people_role_10 TEXT, people_phone_10 TEXT, people_note_10 TEXT,
    created_at TEXT DEFAULT (datetime('now')),
    updated_at TEXT DEFAULT (datetime('now'))
);
