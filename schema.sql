...
CREATE TABLE IF NOT EXISTS persons (
    ...
    med_name_1 TEXT, med_dose_1 TEXT, med_directions_1 TEXT, med_note_1 TEXT,
    med_name_2 TEXT, med_dose_2 TEXT, med_directions_2 TEXT, med_note_2 TEXT,
    med_name_3 TEXT, med_dose_3 TEXT, med_directions_3 TEXT, med_note_3 TEXT,
    med_name_4 TEXT, med_dose_4 TEXT, med_directions_4 TEXT, med_note_4 TEXT,
    med_name_5 TEXT, med_dose_5 TEXT, med_directions_5 TEXT, med_note_5 TEXT,
    med_name_6 TEXT, med_dose_6 TEXT, med_directions_6 TEXT, med_note_6 TEXT,
    med_name_7 TEXT, med_dose_7 TEXT, med_directions_7 TEXT, med_note_7 TEXT,
    med_name_8 TEXT, med_dose_8 TEXT, med_directions_8 TEXT, med_note_8 TEXT,
    med_name_9 TEXT, med_dose_9 TEXT, med_directions_9 TEXT, med_note_9 TEXT,
    med_name_10 TEXT, med_dose_10 TEXT, med_directions_10 TEXT, med_note_10 TEXT,
    med_name_11 TEXT, med_dose_11 TEXT, med_directions_11 TEXT, med_note_11 TEXT,
    med_name_12 TEXT, med_dose_12 TEXT, med_directions_12 TEXT, med_note_12 TEXT,
