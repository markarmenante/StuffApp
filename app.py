...
VALUE_LISTS = {
    ...
    'location_status': ['Storage','Archived','Consigned','Missing','Gifted'],
...
FIELDS = {
    'watches': [
        ...
        {'name': 'location_status', 'label': 'Status',            'type': 'select',
         'options': ['', 'Storage', 'Archived', 'Consigned', 'Missing', 'Gifted']},
